                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="../views/auth/login.php">Log Out</a> <?php }
                            else { ?>
    ...
    <section  class="search">
        ...
        <!-- <form class="form-inline"> -->
            <div class="form-group mb-2">
                ...
                <input id="text_search" type="text" name="keywords" placeholder="Keywords">
            ...
            <button onclick='search()' type="submit" class="btn btn-primary mb-2">Search</button>
        <!-- </form> -->
    </section>

    <!--------------------------  card  --------------------->
    <section class="light">
        <h2 class="text-center py-3">atest Job Listings</h2>
        <div id="searched_offre" class="container py-2">
            <?php
